...
// Custom MonttyLogo for landing page - always uses red colors
function LandingMonttyLogo() {
  const rectangles = [
    { baseX: 0, baseY: 8, height: 12 },
    { baseX: 8, baseY: 6, height: 16 },
    { baseX: 16, baseY: 2, height: 24 },
    { baseX: 24, baseY: 4, height: 20 },
    { baseX: 32, baseY: 10, height: 10 },
  ];
  ...
  return (
    <div className="flex items-center space-x-3">
      ...
      <div className="flex flex-col">
        <span className="text-xl font-bold text-red-600" style={{ fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', sans-serif" }}>
          Montty
        </span>
      </div>
    </div>
...
export default function Landing() {
  ...
  const [isDarkMode, setIsDarkMode] = useState(false) // Simple theme state - keep all other logic identical
      ...
      <section id="what-you-get" className={`py-32 px-6 ${
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
            ...
            <div 
              ref={card1Ref}
              className={`bg-white dark:bg-slate-800 rounded-3xl p-8 pt-8 pb-20 shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col items-center justify-center text-center transition-all duration-400 ease-out ${
                visibleCards.has(1) 
